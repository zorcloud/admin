...
import { Popover, Badge, Avatar, Image } from 'antd';
  ...
  return (
    <header className={classnames}>
      ...
      <ul className="nav navbar-nav navbar-left clearfix">
        ...
        {isMobile ? (
          <li className="mini-search" onClick={onOpenSearchBox}>
            <a>
      ...
      <ul className="nav navbar-nav navbar-right clearfix">
        <li>
          <a href="https://github.com/tzq1476/admin">
        ...
        <li className="dropdown">
          ...
          >
            <a className="dropdown-toggle">
              <Badge dot>
                <Avatar src={avatar}>{user.userName}</Avatar>
              </Badge>
            </a>
          </Popover>
        </li>
      </ul>
      <SearchBox visible={openSearchBox} onClose={onCloseSearchBox} />
    </header>
  );
};
